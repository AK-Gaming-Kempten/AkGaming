...
public sealed class DisbursementsApiClient(HttpClient http) : ApiClientBase(http)
{
    ...
    public Task<Result<AllocationDto>> UpdateAllocationAsync(Guid allocationId, SaveAllocationRequest request, CancellationToken cancellationToken = default) => PutJsonAsync<SaveAllocationRequest, AllocationDto>($"disbursements/admin/allocations/{allocationId}", request, cancellationToken);
    public Task<Result> SendAllocationNotificationAsync(Guid allocationId, CancellationToken cancellationToken = default) => PostJsonAsync($"disbursements/admin/allocations/{allocationId}/notification", new { }, cancellationToken);
    ...
    public Task<Result<AllocationApplicationDto>> UpdateMyApplicationAsync(Guid token, Guid applicationId, UpdateAllocationApplicationRequest request, CancellationToken cancellationToken = default) => PutJsonAsync<UpdateAllocationApplicationRequest, AllocationApplicationDto>($"disbursements/allocations/share/{token}/applications/{applicationId}", request, cancellationToken);
    public Task<Result<AllocationApplicationDto>> CancelMyApplicationAsync(Guid token, Guid applicationId, CancellationToken cancellationToken = default) => PostJsonAsync<object, AllocationApplicationDto>($"disbursements/allocations/share/{token}/applications/{applicationId}/cancel", new { }, cancellationToken);
    ...
    public Task<Result<AllocationApplicationDto>> UpdateApplicationAsync(Guid applicationId, UpdateAllocationApplicationRequest request, CancellationToken cancellationToken = default) => PutJsonAsync<UpdateAllocationApplicationRequest, AllocationApplicationDto>($"disbursements/admin/applications/{applicationId}", request, cancellationToken);
    public Task<Result<AllocationApplicationDto>> CancelApplicationAsync(Guid applicationId, CancellationToken cancellationToken = default) => PostJsonAsync<object, AllocationApplicationDto>($"disbursements/admin/applications/{applicationId}/cancel", new { }, cancellationToken);
