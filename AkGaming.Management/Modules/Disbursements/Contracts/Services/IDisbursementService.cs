...
public interface IDisbursementService
{
    ...
    Task<Result> SendAllocationNotificationAsync(Guid allocationId, CancellationToken cancellationToken = default);
...
public interface IDiscordGuildCatalogService
{
    Task<Result<DiscordGuildCatalogDto>> GetAsync(CancellationToken cancellationToken = default);
}
