...
noreferrer">https://www.hetzner.com/de/legal/privacy-policy/</a>.</p> <p>Die Verwendung von Hetzner erfolgt
                ...
                dieser Website ist:</p> <p>AK Gaming e.V.<br />
                Bahnhofstra&szlig;e 61<br />
                87435 Kempten (Allg&auml;u)</p>
                <p>E-Mail: info@akgaming.de</p>
                ...
                <h3>Social-Media-Elemente mit Shariff</h3> <p>Auf dieser Website werden Elemente von sozialen Medien
                verwendet (z.&nbsp;B. Facebook, X, Instagram, Pinterest, XING, LinkedIn, Tumblr).</p> <p>Die Social-Media-
                Elemente k&ouml;nnen Sie in der Regel anhand der jeweiligen Social-Media-Logos erkennen. Um den Datenschutz
                auf dieser Website zu gew&auml;hrleisten, verwenden wir diese Elemente nur zusammen mit der sogenannten
                &bdquo;Shariff&ldquo;-L&ouml;sung. Diese Anwendung verhindert, dass die auf dieser Website integrierten Social-
                Media-Elemente Ihre personenbezogenen Daten schon beim ersten Betreten der Seite an den jeweiligen Anbieter
                &uuml;bertragen.</p> <p>Erst wenn Sie das jeweilige Social-Media-Element durch Anklicken der zugeh&ouml;rigen
                Schaltfl&auml;che aktivieren, wird eine direkte Verbindung zum Server des Anbieters hergestellt (Einwilligung).
                Sobald Sie das Social-Media-Element aktivieren, erh&auml;lt der jeweilige Anbieter die Information, dass Sie mit
                ...
                zuordnen.</p> <p>Das Aktivieren des Plugins stellt eine Einwilligung im Sinne des Art. 6 Abs. 1 lit. a DSGVO und
                &sect; 25 Abs. 1 TDDDG dar. Diese Einwilligung k&ouml;nnen Sie jederzeit mit Wirkung f&uuml;r die Zukunft
                widerrufen.</p> <p>Der Einsatz des Dienstes erfolgt, um die gesetzlich vorgeschriebenen Einwilligungen f&uuml;r
                den Einsatz bestimmter Technologien einzuholen. Rechtsgrundlage hierf&uuml;r ist Art. 6 Abs. 1 lit. c DSGVO.</p>
