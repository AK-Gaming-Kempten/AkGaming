...
One-page internal shortcut dashboard for AK Gaming services and channels.

## Features

- Classical category board layout for shortcuts
...
- Local browser persistence for the dashboard configuration
- Manual service reachability checks with status indicator
