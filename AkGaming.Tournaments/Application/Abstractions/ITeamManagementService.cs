...
public interface ITeamManagementService
{
    ...
    Task<TeamDto> CreateTeamAsync(string actingUserId, string name, CancellationToken cancellationToken = default);
    ...
    Task<PlayerProfileDto> CreateGuestPlayerProfileAsync(Guid teamId, string actingUserId, string gameId, string name, CancellationToken cancellationToken = default);
