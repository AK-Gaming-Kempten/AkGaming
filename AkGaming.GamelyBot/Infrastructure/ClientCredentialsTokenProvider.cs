...
public sealed class ClientCredentialsTokenProvider(IHttpClientFactory httpClientFactory, IOptions<IdentityClientOptions> options)
{
    ...
    public async Task<string?> GetTokenAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var client = httpClientFactory.CreateClient(nameof(ClientCredentialsTokenProvider));
