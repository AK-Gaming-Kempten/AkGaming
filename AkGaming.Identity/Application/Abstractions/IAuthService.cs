...
{
    Task<CurrentUserResponse> RegisterInteractiveAsync(RegisterRequest request, string? ipAddress, CancellationToken cancellationToken);
    Task<AuthResponse> RegisterAsync(RegisterRequest request, string? ipAddress, CancellationToken cancellationToken);
    Task<CurrentUserResponse> LoginInteractiveAsync(LoginRequest request, string? ipAddress, CancellationToken cancellationToken);
    ...
    Task<AdminAuditLogsResponse> GetAuditLogsAsync(int page, int pageSize, string? search, CancellationToken cancellationToken);
